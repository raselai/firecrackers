              ...
              <div className="navbar-dropdown-container">
                ...
                {isUserMenuOpen && (
                  ...
                  >
                    ...
                    <Link href="/account/notifications" className="dropdown-link user-dropdown-link">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {!loading && (
            user ? (
              <div className="mobile-user-section">
                ...
                <Link href="/account/notifications" className="mobile-link" onClick={handleMobileMenuClick}>
                  Notifications
                </Link>
