...
export default function SearchPage({ products }: SearchClientProps) {
  ...
  useEffect(() => {
    ...
    const searchResults = safeProducts.filter(product => {
  ...
  }, [query, safeProducts, selectedCategory, priceRange, availability, sortBy, locale]);
