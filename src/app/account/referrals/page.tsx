    ...
    const fetchData = async () => {
      if (user) {
        try {
          ...
          setError(t('accountReferrals.errorLoad'));
          setStats({
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">{t('accountReferrals.loading')}</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <main className="flex-1">
            <h1 className="text-3xl font-bold text-gray-900 mb-8">{t('accountReferrals.title')}</h1>
            {error && (
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-lg shadow-md p-8 mb-8 text-white">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* Left: Referral Code */}
                <div>
                  <h2 className="text-2xl font-bold mb-4">{t('accountReferrals.yourCode')}</h2>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      ...
                      {copied ? t('accountReferrals.copied') : t('accountReferrals.copyCode')}
                    </button>
                    <button
                ...
                <div className="flex flex-col items-center">
                  <h3 className="text-xl font-bold mb-4">{t('accountReferrals.scanQr')}</h3>
                  {qrCode ? (
                    <div className="bg-white p-4 rounded-lg mb-4">
                      <img src={qrCode} alt={t('accountReferrals.qrAlt')} className="w-48 h-48" />
                    </div>
                  ) : (
              ...
              <div className="mt-6 pt-6 border-t border-white/20">
                <p className="text-white/90 mb-3 font-medium">{t('accountReferrals.shareVia')}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-sm font-medium text-gray-600 mb-2">{t('accountReferrals.totalReferrals')}</h3>
                <p className="text-3xl font-bold text-gray-900">{safeStats.totalReferrals}</p>
              </div>
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-sm font-medium text-gray-600 mb-2">{t('accountReferrals.availableVouchers')}</h3>
                <p className="text-3xl font-bold text-green-600">{safeStats.availableVouchers}</p>
                <p className="text-sm text-gray-500">
                  {formatTemplate(t('accountReferrals.voucherValue'), { value: voucherValue })}
                </p>
              </div>
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-sm font-medium text-gray-600 mb-2">{t('accountReferrals.usedVouchers')}</h3>
                <p className="text-3xl font-bold text-gray-900">{safeStats.usedVouchers}</p>
              </div>
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-sm font-medium text-gray-600 mb-2">{t('accountReferrals.totalSavings')}</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-8">
              <h2 className="text-xl font-bold text-gray-900 mb-6">{t('accountReferrals.howItWorks')}</h2>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="text-center">
                  <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-2xl font-bold text-orange-600">1</span>
                  </div>
                  <h3 className="font-semibold text-gray-900 mb-2">{t('accountReferrals.steps.shareTitle')}</h3>
                  <p className="text-sm text-gray-600">
                    {t('accountReferrals.steps.shareBody')}
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">{t('accountReferrals.steps.signupTitle')}</h3>
                  <p className="text-sm text-gray-600">
                    {t('accountReferrals.steps.signupBody')}
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">{t('accountReferrals.steps.rewardTitle')}</h3>
                  <p className="text-sm text-gray-600">
                    {t('accountReferrals.steps.rewardBody')}
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">{t('accountReferrals.steps.useTitle')}</h3>
                  <p className="text-sm text-gray-600">
                    {t('accountReferrals.steps.useBody')}
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Referrals List */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-6">{t('accountReferrals.yourReferrals')}</h2>
              {safeStats.referrals.length > 0 ? (
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-gray-200">
                        <th className="text-left py-3 px-4 font-semibold text-gray-700">{t('accountReferrals.table.email')}</th>
                        <th className="text-left py-3 px-4 font-semibold text-gray-700">{t('accountReferrals.table.dateJoined')}</th>
                        <th className="text-left py-3 px-4 font-semibold text-gray-700">{t('accountReferrals.table.status')}</th>
                      </tr>
                    </thead>
                    <tbody>
                            ...
                            <td className="py-3 px-4">
                              {referral.voucherAwarded ? (
                                <span className="inline-flex items-center gap-1 bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-medium">
                                  ...
                                  {t('accountReferrals.voucherAwarded')}
                                </span>
                              ) : (
                                <span className="inline-block bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-sm font-medium">
                                  {t('accountReferrals.pending')}
                                </span>
                              )}
                            </td>
                          </tr>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">{t('accountReferrals.emptyTitle')}</p>
                  <p className="text-sm text-gray-500">{t('accountReferrals.emptyBody')}</p>
                </div>
              )}
            </div>
          </main>
